...
namespace WaveEngine.Components.Transitions
{
    ...
    public class CoverTransition : ScreenTransition
    {
        ...
        protected override void Draw(TimeSpan gameTime)
        {
            ...
            this.SetRenderState();
            this.spriteBatch.Draw(sourceRenderTarget, Vector2.Zero, null, Color.White, 0f, Vector2.Zero, Vector2.One, SpriteEffects.None, 0.5f);
            this.spriteBatch.Draw(targetRenderTarget, this.position, null, Color.White, 0f, Vector2.Zero, Vector2.One, SpriteEffects.None, 0f);
