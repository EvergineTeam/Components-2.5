...
namespace WaveEngine.Components.UI
{
    ...
    public class ImageAtlas : Control
    {
        ...
        protected override void Initialize()
        {
            ...
            {
                TextureAtlas = WaveServices.Assets.Global.LoadAsset<TextureAtlas>(this.AtlasPath);
            }
            else
            {
                TextureAtlas = Assets.LoadAsset<TextureAtlas>(this.AtlasPath);
            }
        ...
        protected void UpdateSourceRectangle()
        {
            ...
            if (TextureAtlas != null)
            {
                ...
                {
                    this.TextureName = TextureAtlas.SpriteRectangles.First().Key;
                }

                this.SourceRectangle = TextureAtlas.SpriteRectangles[this.textureName];
